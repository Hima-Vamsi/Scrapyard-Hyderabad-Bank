...
interface PickReceiverProps {
    onSelect: (email: string) => void;
}

const PickReceiver: React.FC<PickReceiverProps> = ({ onSelect }) => {
    ...
    useEffect(() => {
        const fetchAttendees = async () => {
            try {
                ...
                const filteredAttendees = data.filter((attendee: any) => attendee.account === 1);
    ...
    const handleChange = (
        ...
        if (value) {
            ...
            if (selectedAttendee) {
                ...
                onSelect(selectedAttendee.email);
            }
        }
    };
